    ...
    <div id="overflow_canvas_container">
        <div id="canvas" style="margin: 0px auto; width: 1200px; height: 2270px;">
            ...
            while ($row = $result_group->fetch()) {
                    ...
                    $t5 = 1018 + 359 * $i;
                if($i % 2 == 0){?>
                <div class="cstlayer" id="layerF5C32B27676ADF0306EDC897B2D93FD2" style="left: 156px; top: <?php echo $t0 ?>px; width: 231px; height: 280px; position: absolute; z-index: 112;" deg="0" mid="" type="chtml">
                ...
                <div class="cstlayer" id="layerFDEB20C44100C61FC88C5AD8FA1BA72B" style="left: 471px; top: <?php echo $t1 ?>px; height: 37px; position: absolute; z-index: 114;" deg="0" mid="" type="title">
                ...
                <div class="cstlayer" id="layer3FBE718F60A8AF1E71111456F9DDD0F2" style="left: 180px; top: <?php echo $t2 ?>px; width: 229px; height: 299px; position: absolute; z-index: 113;" deg="0" mid="" type="media">
                    <script>
                    ...
                    <div class="wp-media_content" style="border-width: 0px; border-style: solid; padding: 0px; width: 230px; height: 299px; overflow: hidden;" type="0">
                        <div class="img_over" style="border-width: 0px; border-color: transparent; width: 230px; height: 299px; overflow: hidden;">
                            ...
                            <img class="img_lazy_load paragraph_image" id="wp-media-image_layer3FBE718F60A8AF1E71111456F9DDD0F2" style="left: -40px; top: 0px; width: auto; height: 298px; position: relative;" src="/index/blank.gif" type="zoom" data-original="<?php echo $group->cover_url?>" />
                        </div>
                    </div>
                    <script>
                        (function () {
                ...
                <div class="cstlayer" id="layer9AF82A918E3A3EF24FFE67E47638B113" style="left: 471px; top: <?php echo $t3 ?>px; width: 196px; height: 28px; position: absolute; z-index: 117;" deg="0" mid="" type="title">
                ...
                <div class="cstlayer" id="layer4A19C00111731ABBAF6DC73A3BEA42A0" style="left: 473px; top: <?php echo $t4 ?>px; width: 552px; height: 10px; position: absolute; z-index: 115;" deg="0" mid="" type="chtml">
                ...
                <div class="cstlayer" id="layer08A571F13CCFE23D409150DEFE811313" style="left: 473px; top: <?php echo $t5 ?>px; width: 588px; height: 128px; position: absolute; z-index: 116;" deg="0" mid="" type="title">
                ...
                <div class="cstlayer" id="layer32378DC18204997BA648C51D4D2A4C3E" style="left: 832px; top: <?php echo $t0 ?>px; width: 231px; height: 280px; position: absolute; z-index: 118;" deg="0" mid="" type="chtml">
                ...
                <div class="cstlayer" id="layer90C22E51DBB9E3FC8BD8BB684D48D90D" style="left: 148px; top: <?php echo $t1 ?>px; height: 36px; position: absolute; z-index: 120;" deg="0" mid="" type="title">
                    <div class="wp-title_content" style="border-width: 0px; border-color: transparent; padding: 0px; height: 36px; display: block; -ms-word-wrap: break-word;">
                        <div>
                            <font color="#333333" face="微软雅黑"><span style="line-height: normal; font-size: 30px;"><?php echo $group->name ?></span></font>
                        </div>
                ...
                <div class="cstlayer" id="layer9165602848CD3C73CFB5474C4144AF4B" style="left: 856px; top: <?php echo $t2 ?>px; width: 230px; height: 299px; position: absolute; z-index: 119;" deg="0" mid="" type="media">
                    <script>
                    ...
                    <div class="wp-media_content" style="border-width: 0px; border-style: solid; padding: 0px; width: 230px; height: 298px; overflow: hidden;" type="0">
                        <div class="img_over" style="border-width: 0px; border-color: transparent; width: 230px; height: 298px; overflow: hidden;">
                            <div class="imgloading" style="z-index: 100;"></div>
                            <img class="img_lazy_load paragraph_image" id="wp-media-image_layer9165602848CD3C73CFB5474C4144AF4B" style="left: -40px; top: 0px; width: auto; height: 298px; position: relative;" src="/index/blank.gif" type="zoom" data-original="<?php echo $group->cover_url ?>" />
                        </div>
                    </div>
                    <script>
                        (function () {
                ...
                <div class="cstlayer" id="layer501AD964516115228BE85F2D21FE3032" style="left: 148px; top: <?php echo $t3 ?>px; width: 196px; height: 28px; position: absolute; z-index: 135;" deg="0" mid="" type="title">
                    <div class="wp-title_content" style="border-width: 0px; border-color: transparent; padding: 0px; width: 197px; height: 28px; display: block; -ms-word-wrap: break-word;">
                        <font color="#89be2e" face="微软雅黑"><span style="line-height: 26px; font-size: 17px;"><?php echo $group->career ?></span></font>
                    </div>
                </div>
                <script>                 $('#layer501AD964516115228BE85F2D21FE3032').triggerHandler('layer_ready');</script>
                <div class="cstlayer" id="layer4C3EDF3F5FB39BFF281B09DAD8051F0F" style="left: 150px; top: <?php echo $t4 ?>px; width: 552px; height: 10px; position: absolute; z-index: 121;" deg="0" mid="" type="chtml">
                    <div class="wp-chtml_content" style="background: none; border-width: 1px 0px 0px; border-style: solid; border-color: rgb(217, 217, 217) transparent transparent; padding: 0px; width: 552px; height: 10px; overflow: hidden;">
                ...
                <div class="cstlayer" id="layer0B4E5DC1B30D7A923D1A69D206EA9983" style="left: 150px; top: <?php echo $t5 ?>px; width: 588px; height: 128px; position: absolute; z-index: 122;" deg="0" mid="" type="title">
                    <div class="wp-title_content" style="border-width: 0px; border-color: transparent; padding: 0px; width: 588px; height: 128px; display: block; -ms-word-wrap: break-word;">
                        <p><font color="#434343" face="微软雅黑"><span style="line-height: 32.2px; font-size: 14px;"><?php echo $group->intro ?></span></font></p>
                    </div>
                </div>
