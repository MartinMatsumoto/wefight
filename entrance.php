...
require_once dirname(__FILE__) . '/structure/contact_us/dao/retain_message_dao.php';
require_once dirname(__FILE__) . '/structure/contact_us/domain/retain_message.php';
